    ...
    },
    {
        ...
        response: () => {
            return {
                ...
                data: {
                    abnormalDevices: [
                        { id: 'D003', name: 'CNC-03', type: 'CNC机床', status: 'fault', location: '车间A-3', errorCode: 'E-301', errorDesc: '主轴温度过高', duration: '2小时15分', priority: 'medium' },
                        { id: 'D013', name: '注塑-05', type: '注塑机', status: 'fault', location: '车间B-7', errorCode: 'W-102', errorDesc: '液压油压力异常', duration: '45分钟', priority: 'medium' },
                        { id: 'D023', name: '冲压-07', type: '冲压机', status: 'fault', location: '车间A-9', errorCode: 'E-205', errorDesc: '模具卡死', duration: '1小时30分', priority: 'medium' },
                        { id: 'D035', name: '装配-03', type: '装配线', status: 'fault', location: '车间B-4', errorCode: 'E-110', errorDesc: '传送带偏移', duration: '3小时', priority: 'medium' },
                        { id: 'D011', name: '注塑-03', type: '注塑机', status: 'warning', location: '车间C-5', errorCode: 'W-201', errorDesc: '包装材料不足', duration: '15分钟', priority: 'high' },
                        { id: 'D027', name: '焊接-03', type: '焊接机器人', status: 'warning', location: '车间C-2', errorCode: 'W-308', errorDesc: '焊丝送丝不畅', duration: '20分钟', priority: 'high' }
                    ],
                }
            }
            ...
            return {
                ...
                data: {
                    faultTableData: [
                        ...
                        { key: '5', id: 'D011', name: '注塑-03', deviceType: '注塑机', status: 'warning', faultCode: 'W-201', faultDesc: '包装材料不足', location: '车间C-5', startTime: '10:30:10', duration: '15分钟', handleStatus: '监控中', priority: 'low' },
                        { key: '6', id: 'D027', name: '焊接-03', deviceType: '焊接机器人', status: 'warning', faultCode: 'W-308', faultDesc: '焊丝送丝不畅', location: '车间C-2', startTime: '10:35:25', duration: '20分钟', handleStatus: '监控中', priority: 'low' }
                    ],
                }
            }
