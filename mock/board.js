    ...
    },
    {
        ...
        response: () => {
            return {
                ...
                data: {
                    abnormalDevices: [
                        { id: 'D003', name: 'CNC-03', type: 'CNC机床', status: 'fault', location: '车间A-3', errorCode: 'E-301', errorDesc: '主轴温度过高', duration: '2小时15分', level: 'fault' },
                        { id: 'D013', name: '注塑-05', type: '注塑机', status: 'fault', location: '车间B-7', errorCode: 'W-102', errorDesc: '液压油压力异常', duration: '45分钟', level: 'fault' },
                        { id: 'D023', name: '冲压-07', type: '冲压机', status: 'fault', location: '车间A-9', errorCode: 'E-205', errorDesc: '模具卡死', duration: '1小时30分', level: 'fault' },
                        { id: 'D035', name: '装配-03', type: '装配线', status: 'fault', location: '车间B-4', errorCode: 'E-110', errorDesc: '传送带偏移', duration: '3小时', level: 'fault' },
                        { id: 'D011', name: '注塑-03', type: '注塑机', status: 'warning', location: '车间C-5', errorCode: 'W-201', errorDesc: '包装材料不足', duration: '15分钟', level: 'high' },
                        { id: 'D027', name: '焊接-03', type: '焊接机器人', status: 'warning', location: '车间C-2', errorCode: 'W-308', errorDesc: '焊丝送丝不畅', duration: '20分钟', level: 'high' }
                    ],
                }
            }
    ...
    },
    {
        ...
        response: () => {
            return {
                ...
                data: {
                    faultTableData: [
                        { key: '1', id: 'D003', name: 'CNC-03', deviceType: 'CNC机床', status: 'fault', faultCode: 'E-301', faultDesc: '主轴温度过高', location: '车间A-3', startTime: '08:20:15', duration: '2小时15分', handleStatus: '处理中', priority: '高' },
                        { key: '2', id: 'D013', name: '注塑-05', deviceType: '注塑机', status: 'fault', faultCode: 'W-102', faultDesc: '液压油压力异常', location: '车间B-7', startTime: '09:05:30', duration: '45分钟', handleStatus: '待维修', priority: '高' },
                        { key: '3', id: 'D023', name: '冲压-07', deviceType: '冲压机', status: 'fault', faultCode: 'E-205', faultDesc: '模具卡死', location: '车间A-9', startTime: '10:15:20', duration: '1小时30分', handleStatus: '处理中', priority: '中' },
                        { key: '4', id: 'D035', name: '装配-03', deviceType: '装配线', status: 'fault', faultCode: 'E-110', faultDesc: '传送带偏移', location: '车间B-4', startTime: '07:35:45', duration: '3小时', handleStatus: '待备件', priority: '中' },
                        { key: '5', id: 'D011', name: '注塑-03', deviceType: '注塑机', status: 'warning', faultCode: 'W-201', faultDesc: '包装材料不足', location: '车间C-5', startTime: '10:30:10', duration: '15分钟', handleStatus: '监控中', priority: '低' },
                        { key: '6', id: 'D027', name: '焊接-03', deviceType: '焊接机器人', status: 'warning', faultCode: 'W-308', faultDesc: '焊丝送丝不畅', location: '车间C-2', startTime: '10:35:25', duration: '20分钟', handleStatus: '监控中', priority: '低' }
                    ],
                }
            }
